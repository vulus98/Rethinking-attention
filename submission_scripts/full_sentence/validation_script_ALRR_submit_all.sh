...
sbatch  --output=./sbatch_log/ALRR/$1/evaluation_outputs/%j.out submission_scripts/full_sentence/validation_script.sh --substitute_model_path$suffix $SCRATCH/pytorch-original-transformer/models/checkpoints/ALRR/$1/  --epoch$suffix $epoch --substitute_type$suffix ALRR --substitute_class$suffix $1 
