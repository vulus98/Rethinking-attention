...
if __name__ == "__main__":
    ...
    parser.add_argument("--substitute_type", type = str, help="Type of approach to use for substitution", choices=["ALRR", "ALR", "mha_separate_heads", "none"], default="none")
    ...
    parser.add_argument("--substitute_type_d", type = str, help="Type of approach to use for substitution", choices=["ALRR", "ALR", "mha_separate_heads", "none"], default="none")
